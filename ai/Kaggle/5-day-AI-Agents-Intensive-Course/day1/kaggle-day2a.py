...
currency_agent = LlmAgent(
    ...
    4. Calcuate the final amount after fees based on the output from `get_fee_for_payment_method` and `get_exchange_rate` methods and provide a clear breakdown.
...
print("  . get_exchange_rate - Gets current exchange rate")
...
print("Enhanced current agent created")
...
async def main():
    response = await enhanced_runner.run_debug(
        "I want to convert 1250 USD to INR using a Bank Transfer. Show me the precise calculation."
    )
